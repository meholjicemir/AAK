/****** Object:  StoredProcedure [dbo].[Document_Insert]    Script Date: 13.11.2017 22:40:02 ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	Else
	Begin
		Set @tipDokumentaId = (Select id From TipoviDokumenata Where name = @tipDokumentaName)
...
/****** Object:  StoredProcedure [dbo].[Document_Update]    Script Date: 13.11.2017 22:40:06 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
